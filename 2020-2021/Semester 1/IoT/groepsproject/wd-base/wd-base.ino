...
const char* WIFI_SSID = "FREE WIFI"; // Fill wifi SSID between quotes
const char* WIFI_PASS = "123456789"; // Fill wifi pass between quotes
...
void driveMotors(int leftMotorDirection, int leftMotorSpeed, int rightMotorDirection, int rightMotorSpeed) {
  digitalWrite(MOTOR_PINS[0], leftMotorDirection);
  digitalWrite(MOTOR_PINS[1], leftMotorDirection);
  analogWrite(MOTOR_CHANNELS[0], leftMotorSpeed);
  analogWrite(MOTOR_CHANNELS[1], leftMotorSpeed);

  digitalWrite(MOTOR_PINS[2], rightMotorDirection);
  digitalWrite(MOTOR_PINS[3], rightMotorDirection);
  analogWrite(MOTOR_CHANNELS[2], rightMotorSpeed);
  analogWrite(MOTOR_CHANNELS[3], rightMotorSpeed);
}
